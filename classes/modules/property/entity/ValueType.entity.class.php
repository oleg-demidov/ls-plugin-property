 ...
 * @since 2.0
 */
class PluginProperty_ModuleProperty_EntityValueType extends Entity
{
    ...
    public function resetAllValue()
    {
         ...
         */
        $this->PluginProperty_Property_RemoveValueTagsByTarget($oValue->getTargetType(), $oValue->getTargetId(),
            $oValue->getPropertyId());
        /**
         * Удаляем из таблицы селектов
         */
        $this->PluginProperty_Property_RemoveValueSelectsByTarget($oValue->getTargetType(), $oValue->getTargetId(),
            $oValue->getPropertyId());
    }
