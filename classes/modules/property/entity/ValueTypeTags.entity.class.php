 ...
 * @since 2.0
 */
class PluginProperty_ModuleProperty_EntityValueTypeTags extends PluginProperty_ModuleProperty_EntityValueType
{
    ...
    public function beforeSaveValue()
    {
        ...
        if ($aTags = $this->getTagsArray()) {
            ...
            foreach ($aTags as $sTag) {
                $oTag = Engine::GetEntity('PluginProperty_ModuleProperty_EntityValueTag');
    ...
    public function removeValue()
    {
         ...
         */
        if ($aTags = $this->PluginProperty_Property_GetValueTagItemsByFilter(array(
