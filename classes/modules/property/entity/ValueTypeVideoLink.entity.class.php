 ...
 * @since 2.0
 */
class PluginProperty_ModuleProperty_EntityValueTypeVideoLink extends PluginProperty_ModuleProperty_EntityValueType
{
    ...
    public function validate()
    {
        ...
        if ($mRes === true) {
            ...
            if ($this->getValueForValidate() and !$this->checkVideo($this->getValueForValidate())) {
                return $this->Lang_Get('plugin.property.notices.validate_value_video_wrong');
            }
            return true;
        } else {
            return $mRes;
